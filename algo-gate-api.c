...
bool register_algo_gate( int algo, algo_gate_t *gate )
{
  ...
  switch ( algo )
  {
    case ALGO_0X10:       	rc = register_hash0x10_algo       	 ( gate ); break;
    ...
    case ALGO_ARGON2D16000: rc = register_argon2d_bcrs_algo  ( gate ); break;
    ...
    case ALGO_CPUOWER:      rc = register_cpupower_algo      ( gate ); break;
    ...
    case ALGO_OCV2:	        rc = register_ocv2_algo	         ( gate ); break;
